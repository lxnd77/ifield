...
export const processSteps: readonly ProcessStep[] = [
  ...
  },
  {
    no: '02',
    name: 'Design',
    desc: 'Our in-house experts produce precise AutoCAD drawings, ensuring accuracy and consistency throughout.',
    tag: 'Precise, in-house drawings.',
    longDesc:
      'Our in-house designers translate the brief into precise AutoCAD drawings and specifications, holding accuracy and consistency across every discipline before a single item is made.',
