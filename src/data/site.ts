...
export const footerServiceLinks: readonly FooterLink[] = [
  ...
  { label: 'Fixed Furniture & Joineries', href: '/capabilities#fixed-furniture-joineries' },
  { label: 'Decorative Lighting', href: '/capabilities#decorative-lighting' },
  { label: 'Window & Floor Treatments', href: '/capabilities#window-treatments' },
  { label: 'Draperies', href: '/capabilities#window-treatments' },
  { label: 'Wet Finishing', href: '/capabilities#fit-outs' },
  { label: 'Loose Furniture', href: '/capabilities#loose-furniture-case-goods' },
...
export const stats: readonly Stat[] = [
  { target: 70, display: '70', sup: '+', label: 'Projects Completed' },
